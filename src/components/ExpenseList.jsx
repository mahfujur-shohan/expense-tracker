...
export default function ExpenseList({ expense }) {
  const [isExpenseSortingExpanded, setIsExpenseSortingExpanded] =
    useState(false);
  const [isExpenseCategoryExpanded, setIsExpenseCategoryExpanded] =
    useState(false);
            ...
            <div className="relative inline-block text-left">
              <div>
                <button
                  ...
                  id="menu-button2"
                  aria-expanded={isExpenseSortingExpanded}
                  aria-haspopup="true"
                  onClick={() => {
                    setIsExpenseSortingExpanded(!isExpenseSortingExpanded);
                    setIsExpenseCategoryExpanded(false);
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="relative inline-block text-left">
              <div>
                <button
                  ...
                  className="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-2 py-1 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                  id="filter-button-2"
                  aria-expanded={isExpenseCategoryExpanded}
                  aria-haspopup="true"
                  onClick={() => {
                    setIsExpenseCategoryExpanded(!isExpenseCategoryExpanded);
                    setIsExpenseSortingExpanded(false);
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
